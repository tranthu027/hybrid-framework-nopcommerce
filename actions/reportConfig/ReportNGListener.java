...
public class ReportNGListener implements ITestListener {
	String projectLocator = System.getProperty("user.dir") + "/reportNGScreenshot/";
	...
	public void onTestFailure(ITestResult result) {
		try {
			...
			System.setProperty("org.uncommons.reportng.escape-output", "false"); // Doan ma de thay doi HTML, co the nhung img vao report
